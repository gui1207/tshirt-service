...
public class TshirtServicePortTypeService extends Service {
    ...
    public final static QName SERVICE = new QName("http://mulesoft.org/tshirt-service", "TshirtServicePortTypeService");
    public final static QName TshirtServicePortTypePort = new QName("http://mulesoft.org/tshirt-service", "TshirtServicePortTypePort");
    static {
